...
export default function SetupTrackerStep2({ navigation }: any) {
  ...
  const handleSave = () => {
    console.log("Setup complete:", selectedRange);
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="px-6 pb-8">
        ...
        >
          ...
          >
            <Text className="text-white text-xl font-bold">Complete Setup</Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
