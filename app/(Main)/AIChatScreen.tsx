    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-row items-center px-6 py-4 border-b border-gray-100">
        ...
        <View className="flex-row items-center">
          <Text className="text-3xl font-bold text-gray-900">Amaris</Text>
          <Text className="text-3xl font-bold text-[#4a1942]">AI</Text>
        </View>
      </View>
      ...
      >
        ...
        <View className="px-6 py-4 border-t border-gray-100">
          <View className="flex-row items-center bg-gray-100 rounded-full px-4 py-3">
            {/* Emoji Button */}
            <TouchableOpacity className="mr-3" onPress={handleEmojiPress}>
            ...
            {/* Camera Button */}
            <TouchableOpacity className="ml-3" onPress={handleCameraPress}>
